  ...
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-5'>
        <div>
            ...
            {show &&(
                <>
                 <h4 className='font-semibold text-2xl'>Any Enquiries</h4>

                 <p className='text-lg font-medium mt-3'>We’re here to assist you with all your queries! Whether you need information about our yarns, bulk orders, or partnership opportunities, feel free to reach out.</p>
                 </>
            )}
